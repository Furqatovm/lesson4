...
const Login = () => {
  return (
    ...
    <div className='flex-col gap-2'>
        <h1 className='text-[#4F4F4F] font-semibold text-[36px] text-center py-6'>Welcome, Log into you account</h1>
    <Form className='bg-white! p-3! w-120!  h-110!'>
        ...
        <Input type={"text"} className='text-[14px]! font-medium! p-2! text-[#8A8A8A]!' placeholder='Create your Login' required />
        <Input type={"submit"} className='text-[14px]! font-medium! p-2! text-white! bg-[#2D88D4]! cursor-pointer!' value={"Login"} />
        <Link to={"/register"}>
        <Input type={"submit"} className='text-[14px]! font-medium! p-2! text-[#2D88D4]! border-none! bg-transparent! cursor-pointer!' value={"Sing up"} />
        </Link>
        </div>
    </Form>
    </div>
