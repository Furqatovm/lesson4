    ...
    <section className='w-[70%] mx-auto my-10'>
            <div className='flex justify-between items-center gap-15'>
                <div className="left flex flex-col gap-4 items-center">
                    ...
                    <img src={`${teacher.img}`} className='rounded-full w-full h-full' alt="" />
                    </div>
...
<path d="M21.25 11.25L17.3375 14.375C16.05 15.4 13.9375 15.4 12.65 14.375L8.75 11.25" stroke="#A7A7A7" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                ...
                <h3 className='text-[#1A1A1A] text-[1rem] font-semibold'>About</h3>
                <p className='text-[#A7A7A7] font-medium text-[1rem] leading-5.25'>Nulla Lorem mollit cupidatat irure. Laborum magna nulla duis ullamco cillum dolor. Voluptate exercitation incididunt aliquip deserunt reprehenderit elit laborum. Nulla Lorem mollit cupidatat irure. Laborum magna nulla duis ullamco cillum dolor. Voluptate exercitation incididunt aliquip deserunt reprehenderit elit laborum. </p>
                <div className='flex justify-between'>
                    <span className='text-[#1A1A1A] text-[12px] font-semibold'>Subject</span>
                    <span className='text-[#1A1A1A] text-[12px] font-semibold'>Class</span>
                </div>
                <div className='flex justify-between'>
                    <span className='text-[#A7A7A7] text-[14px] font-medium'>{teacher.subject}</span>
                    <span className='text-[#A7A7A7] text-[14px] font-medium'>{teacher.class}</span>
                </div>

                <div className='flex justify-between'>
                    <span className='text-[#1A1A1A] text-[12px] font-semibold'>Age</span>
                    <span className='text-[#1A1A1A] text-[12px] font-semibold'>Gender</span>
                </div>

                <div className='flex justify-between'>
                    <span className='text-[#A7A7A7] text-[14px] font-medium'>{teacher.age}</span>
                    <span className='text-[#A7A7A7] text-[14px] font-medium'>{teacher.gender}</span>
                </div>
